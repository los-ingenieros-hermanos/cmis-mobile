    ...
    _onLoginButton= () => {
      ...
      <View style={LoginScreenStyles.container}>
          ...
          <View style={{flexDirection:'row'}}>
              ...
              />
              <TextInput placeholder='Kullanıcı Adı' placeholderTextColor='rgba(165,165,165,1)' cursorColor={'rgba(84,70,115,1)'}  style={LoginScreenStyles.textinput} />
          ...
          <View style={{flexDirection:'row'}}>
              ...
              style={LoginScreenStyles.atsignLogin}  
              />
              <TextInput placeholder='İsim Soyisim' placeholderTextColor='rgba(165,165,165,1)' cursorColor={'rgba(84,70,115,1)'} style={LoginScreenStyles.textinput} />              
          </View>
          ...
          <TouchableNativeFeedback onPress={()=>navigation.push('Login')}>
            ...
            <Text style={LoginScreenStyles.RegisterInnerText}>
              cmis
              <Text style={LoginScreenStyles.RegisterOuterText}> Hesabın İle Giriş Yap </Text>
            </Text>
            </View>
          </TouchableNativeFeedback>
