    ...
    return (
      <Fragment>
        ...
        <Calendar
          ...
          // adjust size of height and width of dayComponent
          dayComponent={({date, state}) => {
            return (
              <TouchableOpacity style={{}}>
                
                <Text style={{left:5}}>{date.day}</Text>
                <View style={{borderRadius:5, borderTopRightRadius:0,borderTopLeftRadius:0,
                              width: width*0.13, height: height*0.12, backgroundColor: 'white', 
                              borderBottomWidth:1, borderLeftWidth:0.2,borderRightWidth:0.2, borderColor:'rgba(84,70,115,0.2)'}}>
                </View>
              </TouchableOpacity>
            );
          }}
